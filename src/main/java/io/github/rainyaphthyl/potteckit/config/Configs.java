...
public class Configs {
    ...
    @Config(types = Type.TOGGLE, domains = Domain.TWEAK, serverSide = true)
    ...
    public static final HotkeyConfig checkChunkLoader = new HotkeyConfig("check_chunk_loader", "C,L");
    @Config(types = Type.TOGGLE, domains = Domain.ACTION, serverSide = true)
    public static final HotkeyedBooleanConfig checkChunkLoaderServer = new HotkeyedBooleanConfig("check_chunk_loader_server", false, "", "check_chunk_loader_server", "check_chunk_loader_server");
    @Config(types = Type.TOGGLE, domains = Domain.ACTION)
    public static final HotkeyedBooleanConfig checkChunkLoaderClient = new HotkeyedBooleanConfig("check_chunk_loader_client", false, "", "check_chunk_loader_client", "check_chunk_loader_client");
